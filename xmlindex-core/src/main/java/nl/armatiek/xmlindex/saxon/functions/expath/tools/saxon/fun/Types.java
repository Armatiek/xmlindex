...
package nl.armatiek.xmlindex.saxon.functions.expath.tools.saxon.fun;
...
public class Types
{
    ...
    public static final SequenceType SINGLE_INT      = BuiltInAtomicType.INT.one();
    public static final SequenceType SINGLE_INTEGER  = SequenceType.SINGLE_INTEGER;
    public static final SequenceType SINGLE_LONG     = BuiltInAtomicType.LONG.one();
    ...
    public static final SequenceType SINGLE_URI      = BuiltInAtomicType.ANY_URI.one();
    // nodes
    ...
    public static final SequenceType OPTIONAL_INT      = BuiltInAtomicType.INT.zeroOrOne();
    public static final SequenceType OPTIONAL_INTEGER  = SequenceType.OPTIONAL_INTEGER;
    public static final SequenceType OPTIONAL_LONG     = BuiltInAtomicType.LONG.zeroOrOne();
    ...
    public static final SequenceType OPTIONAL_DOCUMENT  = make(OPTIONAL, DOCUMENT);
