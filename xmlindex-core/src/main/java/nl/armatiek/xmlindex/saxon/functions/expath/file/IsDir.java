 ...
 */
public class IsDir extends EXPathFileExtensionFunctionDefinition {

  private static final StructuredQName qName = 
      new StructuredQName("", NAMESPACEURI_EXPATH_FILE, "is-dir");
  ...
  private static class IsDirCall extends FileExtensionFunctionCall {
    ...
    public Sequence call(XPathContext context, Sequence[] arguments) throws XPathException {      
      try {                               
        ...
        return BooleanValue.get(file.isDirectory());        
      } catch (Exception e) {
