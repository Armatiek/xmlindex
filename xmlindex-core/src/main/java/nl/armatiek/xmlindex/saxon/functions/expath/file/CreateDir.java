...
/**
 * XPath extension function that creates a directory, or does nothing if the directory already exists.
 * 
 * @author Maarten Kroon
 * @see <a href="http://expath.org/spec/file">EXPath File Module</a>
 */
public class CreateDir extends EXPathFileExtensionFunctionDefinition {

  private static final StructuredQName qName = 
      new StructuredQName("", NAMESPACEURI_EXPATH_FILE, "create-dir");
