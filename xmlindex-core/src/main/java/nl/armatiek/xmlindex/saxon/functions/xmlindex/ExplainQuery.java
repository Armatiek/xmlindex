 ...
 */
public class ExplainQuery extends ExtensionFunctionDefinition {
  
  private static final Logger logger = LoggerFactory.getLogger(ExplainQuery.class);
    
  private static final StructuredQName qName = 
      new StructuredQName("", Definitions.NAMESPACE_EXT_FUNCTIONS, "explain-query");
  ...
  public ExtensionFunctionCall makeCallExpression() {
    return new ExplainQueryCall();
  }
    
  private static class ExplainQueryCall extends TransformOrQueryCall {
    ...
    public Sequence call(XPathContext context, Sequence[] arguments) throws XPathException {            
      ...
      try {
        ...
        if (throwErrors)
          throw e;
        logger.error("Error explaining XQuery on index \"" + session.getIndex().getIndexName() + "\"", e);
