...
/**
 * XPath extension function that writes a sequence of items to a file. 
 * 
 * @author Maarten Kroon
 * @see <a href="http://expath.org/spec/file">EXPath File Module</a>
 */
public class Write extends EXPathFileExtensionFunctionDefinition {

  private static final StructuredQName qName = new StructuredQName("", NAMESPACEURI_EXPATH_FILE, "write");
